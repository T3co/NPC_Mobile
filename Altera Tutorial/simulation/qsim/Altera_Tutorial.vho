...
\outp~output\ : fiftyfivenm_io_obuf
...
-- Equation(s):
-- \count~5_combout\ = (\Add0~14_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~4_combout\ = (\Add0~24_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~2_combout\ = (\Add0~28_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~1_combout\ = (\Add0~30_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~0_combout\ = (\Add0~34_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(17) & (count(15) & (count(14) & !count(16))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (count(13) & (count(12) & (!count(11) & !count(10))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (count(6) & (!count(9) & (!count(8) & !count(7))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (count(5) & (count(4) & (count(3) & count(2))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (count(1) & (count(0) & (count(19) & !count(18))))
...
-- Equation(s):
-- \count~8_combout\ = (\Add0~42_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~9_combout\ = (\Add0~44_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~11_combout\ = (\Add0~50_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \outp~0_combout\ = \outp~reg0_q\ $ (\Equal0~8_combout\)

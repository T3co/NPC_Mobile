...
ww_clk <= clk;
ledOUT <= IEEE.STD_LOGIC_1164.TO_BIT(ww_ledOUT);
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;

\ledOUT~output\ : fiftyfivenm_io_obuf
...
-- Equation(s):
-- \Equal0~1_combout\ = (count(6) & (!count(9) & (!count(8) & !count(7))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (count(5) & (count(4) & (count(3) & count(2))))
...
-- Equation(s):
-- \count~3_combout\ = (\Add0~28_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \count~4_combout\ = (\Add0~30_combout\ & !\Equal0~8_combout\)
...
-- Equation(s):
-- \Equal0~3_combout\ = (count(1) & (count(0) & (count(14) & count(15))))
...
\pulse~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
